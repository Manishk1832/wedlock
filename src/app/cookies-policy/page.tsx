      ...
      <div className="flex flex-col md:flex-row flex-grow gap-5 p-4 md:p-16">
        ...
        <div className="">
          ...
          <ul className="list-disc pl-4 underline pb-4">
            <li><Link href={"https://www.allaboutcookies.org"}>https://www.allaboutcookies.org</Link></li>
            <li><Link href={"https://www.youronlinechoices.eu"}>www.youronlinechoices.eu</Link></li>
            <li><Link href={"http://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html"}>http://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html</Link></li>
          </ul>
