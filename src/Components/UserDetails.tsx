...
import "../app/font.css";
import ReligiouModel from "./UserDetailsModel/ReligiousModel";
import FamilyModel from "./UserDetailsModel/FamilyModel";
import PersonalBagroundModal from "./UserDetailsModel/PersonalBagroundModal";
import EducationFinancialModal from "./UserDetailsModel/EducationFinancialModal";
import LocationBackgroundModal from "./UserDetailsModel/LocationBackgroundModal";
import InterestHobbiesModal from "./UserDetailsModel/InterestHobbiesModal";
import LifestyleModel from "./UserDetailsModel/LifestyleModal";
...
console.log(myDetails,"myDetails");
  ...
  {myDetails?.data[0]?.profileImage.map((imageUrl: string, index: number) => (
    <Image
      key={index}
      src={imageUrl}
      alt="profile image"
    ...
    />
        ...
        <div className="col-span-1 grid w-full gap-4 md:col-span-2">
          <div className="col-span-1 w-[100%] rounded-xl bg-white p-6 md:col-span-2 md:w-auto xl:h-[29rem]">
            <div className="flex w-full flex-col items-center justify-between gap-10 xl:flex-row">
              <div className=" xl:w-[70%] w-full">
                <div className="flex items-center justify-between self-start text-sm font-semibold leading-5 text-zinc-900">
                  Basic & Lifestyle
                ...
                <div className="mt-4 flex flex-col px-6 max-md:max-w-full max-md:px-5">
              ...
              <div className="h-[28rem] xl:w-[30%] w-auto rounded-lg bg-[#FEE7BD] p-5 md:h-[26rem]">
                ...
                <div className="mt-2 text-center text-lg text-[#007EAF] underline">
                  <Link href={"/questions"}> Click to complete profile</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-75% flex flex-col rounded-xl bg-white md:w-auto xl:h-[18rem]">
          ...
          <div className="h-[20rem] rounded-xl bg-white">
            ...
            <div className="mt-6 flex flex-col px-6 max-md:max-w-full max-md:px-5">
              ...
              <div className="mt-4 flex justify-between gap-0 max-md:flex-wrap">
                ...
                <div className="justify-center self-start rounded-[100px] bg-purple-100 px-3 py-1.5 text-center text-base font-medium capitalize leading-4 tracking-normal text-violet-600">
                  {myDetails?.data[0]?.location_background?.cityOfResidence  ||"Not Specified"}
                </div>
              </div>
              <div className="mt-4 flex justify-between gap-0 max-md:flex-wrap">
                <div className="text-md flex-1 font-normal leading-8 tracking-wide text-slate-600 md:text-xl">
          ...
          <div className="h-[12rem] rounded-xl">
            <div className="mb-10 flex max-w-[499px] flex-col pb-9 leading-8 text-slate-900">
              ...
              <div className="mt-4 flex gap-2.5 whitespace-nowrap text-center capitalize tracking-wide max-md:pr-5 md:flex-wrap">
                  ...
                  {myDetails?.data[0]?.interest_and_hobbies?.map((interest: string) => (
            ...
            <div className="flex flex-col rounded-xl border border-solid border-gray-200 bg-white pb-6 shadow-sm">
              ...
              <div className="mt-6 flex flex-col px-6 max-md:px-5">
                ...
                <div className="mt-4 flex justify-between gap-2 pr-8 max-md:pr-5">
                  ...
                  <div className="justify-center rounded-[100px] bg-orange-100 px-3 py-1.5 text-center text-sm font-medium capitalize leading-7 text-slate-900 md:text-lg">
                    $<span className="">{myDetails?.data[0]?.education_and_financial?.income}</span>
                  </div>
                </div>
              </div>
            </div>
